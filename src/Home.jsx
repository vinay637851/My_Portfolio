...
function Home(){
    return(
        <div id="Home" className="w-screen relative min-h-screen max-h-max flex flex-col justify-center items-center bg-gray-50">
            <div className="w-screen h-max flex flex-col md:flex-row  justify-center items-center">
                <div className='w-screen md:w-1/2 h-max p-5 flex items-center md:items-baseline flex-col justify-center gap-[4vh]'>
                    <h3 className='w-max p-1 px-3 h-max font-medium bg-indigo-100 text-indigo-800 rounded-[2vh]'>👋 Welcome to my portfolio</h3>
                    <h1 className='text-6xl font-bold text-gray-800'>Hi, I'm  <span className='text-transparent bg-gradient-to-r from-purple-800 to-indigo-800 bg-clip-text'>Vinay Sharma</span></h1>
                ...
                <div className='w-screen p-5 mt-10 mb-10 h-max md:w-1/3 flex justify-center items-center'>
                    <span className='h-fit w-fit p-3 rounded-[50%] bg-white flex justify-center items-center shadow-[0px_1px_5px_lightgray] relative top-[-15vh] left-[2vh]'><Code className='text-purple-700'/></span>
                    <img src={Image} className='h-60 w-60 outline-[2px] shadow-2xl object-cover outline-gray-600 rounded-[50%]' alt="" />
                    <span className='h-fit w-fit p-3 rounded-[50%] bg-white flex justify-center items-center shadow-[0px_1px_5px_lightgray] relative bottom-[-15vh] left-[-2vh] animate-bounce'><Coffee className='text-indigo-600'/></span>
                </div>
            </div>
            <ChevronDown className='absolute bottom-2 animate-ping'/>
        </div>
    )
}
